...
if __name__ == '__main__':
    ...
    coco_img_path = '../data/coco/val2017/'
    ...
    for batch in dataloader:
        ...
        image_path = os.path.join(coco_img_path, file_name)
        history = []
    ...
    np.save('./assets/text/gen_captions.npy', save_dic)